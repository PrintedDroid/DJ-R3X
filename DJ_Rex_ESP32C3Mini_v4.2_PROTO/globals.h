...
extern CRGB* DJLEDs_Right;    // Points to bodyLEDsChained[0]
extern CRGB* DJLEDs_Middle;   // Points to bodyLEDsChained[56]  
extern CRGB* DJLEDs_Left;     // Points to bodyLEDsChained[112]
extern CRGB* DJLEDs_Eyes;     // Points to eyesMouthLEDs[80]
extern CRGB* DJLEDs_Mouth;    // Points to eyesMouthLEDs[0]
