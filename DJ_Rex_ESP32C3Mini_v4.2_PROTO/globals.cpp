...
CRGB* DJLEDs_Right = &bodyLEDsChained[0];                          // LEDs 0-55
CRGB* DJLEDs_Middle = &bodyLEDsChained[NUM_LEDS_PER_PANEL];        // LEDs 56-111  
CRGB* DJLEDs_Left = &bodyLEDsChained[NUM_LEDS_PER_PANEL * 2];      // LEDs 112-167
