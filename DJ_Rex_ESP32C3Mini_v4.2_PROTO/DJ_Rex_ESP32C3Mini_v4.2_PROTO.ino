/////////////////////////////////////////////////////////////////////////////////
//
// Sketch for the Printed Droid DJ Rex Body Light Panels (ESP32-C3 Mini)
// 
// Version 4.2.0 - 2025/07 - Enhanced Edition
//
// Hardware: ESP32-C3 Mini
// Serial speed: 115200
//
// LED Layout:
// - 3 Body Panels: Each 20 LEDs (8 side + 3x4 blocks)
// - 2 Eyes LEDs
// - 80 Mouth LEDs in 12 rows
//
// Using 2 RMT channels (Body Panels: Right -> Middle -> Left & Mouth -> Eyes)
//
// Use Fastled 3.9.0!!!
//
// Fixes:
// - Corrected all header file issues
// - Fixed missing function implementations  
// - Proper thread synchronization
// - Complete status LED patterns
// - Increased WebSocket buffer size
// - Added all missing preset manager functions
// - Fixed thread-safety issues (race conditions) in the audio processor.
// - Unified the audio processing pipeline to a single, efficient system.
// - Removed redundant and legacy code.
//
// CRITICAL FIXES APPLIED:
// - Fixed memory leaks in PresetManager
// - Added thread-safe LED operations
// - Implemented proper pattern manager
...
void setup() {
    ...
    // Initialize status LED immediately
    initStatusLED();
    ...
    Serial.println(F("\n========================================"));
    Serial.println(F("DJ Rex ESP32-C3 v4.2.0 - FIXED EDITION"));
    Serial.println(F("Build: " FIRMWARE_DATE));
    Serial.println(F("========================================"));
    Serial.println(F("Hardware: ESP32-C3 Mini - 4 RMT channels"));
