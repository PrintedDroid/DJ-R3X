...
// Version information
#define FIRMWARE_VERSION "4.2.0-FIXED"
#define FIRMWARE_DATE "2025-01"
#define BUILD_NUMBER 20250101

// Hardware configuration
#define NUM_LEDS_PER_PANEL 56
#define NUM_EYES 2
#define NUM_MOUTH_LEDS 80
#define TOTAL_BODY_LEDS (NUM_LEDS_PER_PANEL * 3)
...
const uint8_t STATUS_LED_PIN = 8;      // IO8 - Blue Status LED
...
// LED Layout definitions (validated)
#define SIDE_LEDS_START 0
#define SIDE_LEDS_COUNT 12
#define BLOCK1_START 12
#define BLOCK2_START 26
#define BLOCK3_START 40
#define LEDS_PER_BLOCK 14
...
#if NUM_LEDS_PER_PANEL != 56
    #error "NUM_LEDS_PER_PANEL must be 56 for this hardware configuration"
#endif

#if TOTAL_BODY_LEDS != 168
    #error "TOTAL_BODY_LEDS calculation is incorrect"
#endif
